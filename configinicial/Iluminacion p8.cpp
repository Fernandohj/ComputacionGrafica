//Práctica 8                      Hernández Juárez Fernando 	
// Fecha de entrega : 29 de marzo de 2026         320115448
...
int main()
{
    ...
    Model alberca((char*)"Models/Alberca y perro.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Limpiar pantalla (Cielo un poco oscuro)
        ...
        // Dibujar el modelo cargado (Alberca)
        glm::mat4 model(1);
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    ...
    if (key == GLFW_KEY_1 && action == GLFW_PRESS) solEncendido = !solEncendido;
    if (key == GLFW_KEY_2 && action == GLFW_PRESS) lunaEncendida = !lunaEncendida;
}
