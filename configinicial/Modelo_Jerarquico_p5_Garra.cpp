//Practica 5	                            Hernández Juárez Fernando 
//Fecha de entrega : 8 de marzo de 2026     320115448
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico Hernandez Juarez Fernando", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        // ================= DEDO 1 =================
        model = glm::rotate(modelTemp2, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        model = glm::translate(model, glm::vec3(1.0f, -0.25f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo1 + 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        color = glm::vec3(0.6f, 0.6f, 0.6f); // Gris metal base dedo
        glUniform3fv(uniformColor, 1, glm::value_ptr(color));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);

        model = glm::translate(modelTemp, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo2 - 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        color = glm::vec3(0.45f, 0.45f, 0.45f); // Gris un poco mas oscuro para articulación
        glUniform3fv(uniformColor, 1, glm::value_ptr(color));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);

        model = glm::translate(modelTemp, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo3 - 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        color = glm::vec3(0.85f, 0.1f, 0.1f); // Rojo Goma
        glUniform3fv(uniformColor, 1, glm::value_ptr(color));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        ...
        // ================= DEDO 2 =================
        model = glm::rotate(modelTemp2, glm::radians(72.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        model = glm::translate(model, glm::vec3(1.0f, -0.25f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo1 + 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        ...
        model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        color = glm::vec3(0.85f, 0.1f, 0.1f);
        glUniform3fv(uniformColor, 1, glm::value_ptr(color));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        ...
        // ================= DEDO 3 =================
        model = glm::rotate(modelTemp2, glm::radians(144.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        model = glm::translate(model, glm::vec3(1.0f, -0.25f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo1 + 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        ...
        // ================= DEDO 4 =================
        model = glm::rotate(modelTemp2, glm::radians(216.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        model = glm::translate(model, glm::vec3(1.0f, -0.25f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo1 + 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
        ...
        // ================= DEDO 5 =================
        model = glm::rotate(modelTemp2, glm::radians(288.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        model = glm::translate(model, glm::vec3(1.0f, -0.25f, 0.0f));
        model = glm::rotate(model, glm::radians(dedo1 + 45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        modelTemp = model = glm::translate(model, glm::vec3(0.0f, -0.4f, 0.0f));
        model = glm::scale(model, glm::vec3(0.25f, 0.8f, 0.25f));
...
void Inputs(GLFWwindow* window) {
    ...
    dedo1 = glm::clamp(dedo1, -20.0f, 15.0f);
    dedo2 = glm::clamp(dedo2, -10.0f, 15.0f);
    dedo3 = glm::clamp(dedo3, -5.0f, 5.0f);
}